...
class ConstellationActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val GoResultButton = findViewById<Button>(R.id.GoResultButton)
        ...
        GoResultButton.setOnClickListener {
            ...
            intent.putIntegerArrayListExtra("result",
                ArrayList(getLottoNumbersFromHash(txtConstell.text.toString())))
    ...
    private fun makeConstellationString(month: Int, day: Int): CharSequence? {
